...
namespace Xharness {
	...
	public class Harness : IHarness {
		...
		void AutoConfigureIOS ()
		{
			...
			IOSTestProjects.Add (new iOSTestProject (TestLabel.BindingsFramework, Path.GetFullPath (Path.Combine (RootDirectory, "bindings-framework-test", "iOS", "bindings-framework-test.csproj")), false) {
			...
			IOSTestProjects.Add (new iOSTestProject (TestLabel.Bindings, Path.GetFullPath (Path.Combine (RootDirectory, "bindings-test", "iOS", "bindings-test.csproj")), false) { Name = "bindings-test" });
